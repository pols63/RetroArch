      ...
      const char *label, unsigned type, size_t idx, size_t entry_idx)
{
   ...
   if (menu_path && *menu_path)
   {
      ...
      task_push_core_restore(backup_path, dir_libretro, NULL, &core_loaded, NULL, false);
   }
   else
      task_push_core_restore(path, dir_libretro, NULL, &core_loaded, NULL, false);
      ...
      const char *label, unsigned type, size_t idx, size_t entry_idx)
{
    ...
    *   confusing/ugly) */
   if (   task_push_core_restore(backup_path, dir_libretro, NULL, &core_loaded, NULL, false)
       && core_loaded)
      menu_entries_flush_stack(NULL, 0);
   return 0;
}
